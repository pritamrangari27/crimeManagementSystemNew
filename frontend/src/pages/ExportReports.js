            ...
            <div className="d-flex align-items-center justify-content-between mb-4" style={{ animation: 'fadeInDown 0.3s ease' }}>
              ...
              <div className="d-flex gap-2">
                {previewData.format === 'excel' && (
                  <Button variant="primary" size="sm" style={{ borderRadius: 8, fontWeight: 600 }} onClick={handleDownloadExcel}>
                    <i className="fas fa-file-excel me-1"></i> Download Excel
                  </Button>
                )}
                {previewData.format === 'pdf' && (
                  <Button variant="danger" size="sm" style={{ borderRadius: 8, fontWeight: 600 }} onClick={handlePrintPDF}>
              ...
              <Row className="g-3">
                <Col md={4}>
                  <Button
                    ...
                    style={{ borderRadius: 12, fontSize: '1rem', transition: 'transform 0.2s' }}
